...
public class BukuPubAdapter extends RecyclerView.Adapter<BukuPubAdapter.CustomViewHolder> {
    private Context context;
    private ArrayList<ModelBuku> modelBuku;
    private LayoutInflater mInflater;

    public BukuPubAdapter(Context context) {
    ...
    @NonNull
    @Override
    public BukuPubAdapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull BukuPubAdapter.CustomViewHolder customViewHolder, int position) {
